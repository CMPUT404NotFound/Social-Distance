    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('png', 'image/png;base64'), ('markdown', 'text/markdown'), ('jpeg', 'image/jpeg;base64'), ('plain', 'text/plain'), ('app', 'application/base64')], default='plain', max_length=20)),
