    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('PU', 'PUBLIC'), ('PR', 'PRIVATE')], default='PU', max_length=8)),
                ...
                ('contentType', models.CharField(choices=[('png', 'image/png;base64'), ('markdown', 'text/markdown'), ('plain', 'text/plain'), ('jpeg', 'image/jpeg;base64'), ('app', 'application/base64')], default='plain', max_length=20)),
