    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('app', 'application/base64'), ('jpeg', 'image/jpeg;base64'), ('markdown', 'text/markdown'), ('plain', 'text/plain'), ('png', 'image/png;base64')], default='plain', max_length=20)),
