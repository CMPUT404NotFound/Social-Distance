    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('jpeg', 'image/jpeg;base64'), ('plain', 'text/plain'), ('app', 'application/base64'), ('png', 'image/png;base64'), ('markdown', 'text/markdown')], default='plain', max_length=20)),
