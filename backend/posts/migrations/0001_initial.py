    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contentType', models.CharField(choices=[('markdown', 'text/markdown'), ('app', 'application/base64'), ('plain', 'text/plain'), ('png', 'image/png;base64'), ('jpeg', 'image/jpeg;base64')], default='plain', max_length=20)),
