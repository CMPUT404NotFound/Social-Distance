...
class Comment(models.Model):
    ...
    comment = models.TextField("comment", max_length=360, blank=True, null=False, default="")

    content_type = models.CharField(
        "content-type", choices=Content_choices, max_length=1, default="P", null=False, blank=False
    )
